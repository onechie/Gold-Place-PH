            ...
            <div class="container-fluid col-12 px-3 mb-4">
                <div class="bg-white rounded-4 overflow-hidden shadow d-flex flex-column align-items-center">
                    <div class="p-4 shadow-sm w-100 shadow-sm z-high">
                        <P class="lt-space fw-light m-0 text-center text-sm-start">USERS LIST</P>
                    </div>
                    ...
                    <div class="w-100 m-0 max-h-ex overflow-auto">
                        <div class="w-100 h-100" style="min-width: 800px">
                            <table class="table table-hover table-borderless table-striped fs-7 bg-white">
                                ...
                                <tbody>
                                    <tr class="align-middle">
                                        <td class="ps-4 py-4">#100</td>
                                        <td class="ps-4">
                                            <div class="d-flex align-items-center">
                                                <span class="position-relative rounded-5 bg-white shadow-sm me-2" style="width:50px; height:50px">
                                                    <img class="position-absolute m-1 bg-primary rounded-5" src="../assets/images/compressed/rick.jpg" alt="" style="width:42px; height:42px">
                                                </span>
                                                <strong>Angelo Parole</strong>
                                            </div>
                                        </td>
                                        <td class="ps-4">angeloparole@gmail.com</td>
                                        <td class="ps-4"><strong>+639260295144</strong></td>
                                        <td class="ps-4"><strong>99</strong></td>
                                        <td class="ps-4">

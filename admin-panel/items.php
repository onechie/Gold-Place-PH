            ...
            <div class="container-fluid col-12 px-3 mb-4">
                <div class="bg-white rounded-4 overflow-hidden shadow d-flex flex-column align-items-center">
                    <div class="p-4 shadow-sm w-100 shadow-sm z-high">
                        <P class="lt-space fw-light m-0 text-center text-sm-start">ITEMS LIST</P>
                    </div>
                        ...
                        <div class="d-flex">
                            ...
                            <div class="btn-group drop-down ps-2">
                                ...
                                <ul class="dropdown-menu dropdown-menu-start border-0 p-0 overflow-hidden shadow">
                                    <li><button class="dropdown-item text-start fs-7 fw-light" type="button">STOCKS</button></li>
                                    <li><button class="dropdown-item text-start fs-7 fw-light" type="button">SOLDS</button></li>
                                </ul>
                            </div>
                        </div>
                            ...
                            <table class="table table-hover table-borderless table-striped fs-7 bg-white">
                                <thead class="sticky-top bg-light z-mid bg-dark text-light">
                                    <tr class=" align-middle">
                                        ...
                                        <th class="ps-4" style="width:30%">STOCKS</th>
                                ...
                                <tbody>
                                    <tr class="align-middle">
                                        <td class="ps-4 py-4">#176</td>
                                        <td class="ps-4">
                                            <div class="d-flex align-items-center">
                                                <span class="position-relative rounded-5 bg-white shadow-sm me-2" style="width:50px; height:50px">
                                                    <img class="position-absolute m-1 bg-primary rounded-5" src="../assets/images/compressed/img1.jpg" alt="" style="width:42px; height:42px">
                                                </span>
                                                <strong>Ring of example</strong>
                                            </div>
                                        </td>
                                        <td class="ps-4">
                                            <p class="p-0 m-0">10/100</p>
                                            <div class="progress bg-dark bg-opacity-25">
                                                <div class="progress-bar bg-danger" role="progressbar" style="width: 10%" aria-label="Basic example" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"></div>
                                            </div>
                                        </td>
                                        <td class="ps-4"><strong>P4,000</strong></td>
                                        <td class="ps-4"><strong>90</strong></td>
                                        <td class="ps-4 d">
                                            <div class="d-flex ">
                                                <a class="text-secondary" href=""><i class="bi bi-pencil-square fs-3"></i></a>
                                                <a class="text-danger" href=""><i class="bi bi-trash fs-3"></i></a>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr class="align-middle">

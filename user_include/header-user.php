          ...
          <table class="table table-hover m-0">
            ...
            <tbody>
              <tr>
                ...
                <td class="text-center align-middle"><img src="./assets/images/defaults/img2.jpg" height="100" width="100" alt=""></td>
        ...
        <table class="table table-hover m-0">
          ...
          <tbody>
            <tr>
              ...
              <td class="text-center align-middle"><img src="./assets/images/defaults/img1.jpg" height="100" width="100" alt=""></td>

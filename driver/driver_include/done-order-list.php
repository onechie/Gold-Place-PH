...
?>
<!--ORDERS-->
<div class="container-fluid px-xl-4 px-0 order-handler-done">
    <div class="container-fluid p-0">
        ...
        <div class="container-fluid p-0 my-4">
            ...
            <div class="px-4 py-3 shadow-sm d-flex w-100 justify-content-center justify-content-sm-between">
                    <P class="lt-space fw-light m-0 text-center text-sm-start">COMPLETED</P>
                        ...
                        <table class="table table-hover table-borderless table-striped fs-7 bg-white">
                            ...
                            <tbody id="order-list">
                                <tr class="align-middle">
                                    ...
                                    <td class="px-4">
                                        <i class="text-success icon-btn bi bi-eye fs-5 view-order-btn" data-bs-toggle='modal' data-bs-target='#view-order'></i>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
